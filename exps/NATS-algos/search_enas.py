...
if __name__ == '__main__':
  ...
  parser.add_argument('--algo'        ,       type=str,   default='enas', choices=['darts-v1', 'darts-v2', 'gdas', 'setn', 'random', 'enas'], help='The search space name.')
  ...
  parser.add_argument('--arch_eps'          , type=float, default=0.001, help='weight decay for arch encoding')
